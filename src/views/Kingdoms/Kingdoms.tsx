    ...
    <>
      <PageHeader>
        ...
        <Heading as="h2" color="secondary" mb="10px" style={{ textAlign: 'left' }}>
          Stake tokens for cross-platform farming plus NBIT rewards
        </Heading>
        ...
        <Heading as="h2" color="warning" mb="10px" style={{ textAlign: 'left' }}>
          CertiK Audit is Pending: Our other contracts have been audited by CertiK and Stake are currently under review. Please use at your own discretion until the audit has been published
        </Heading>
        <FeeWrapper>
          ...
          <Flex justifyContent="space-between">
            <Text>Fee for NBIT Staking Kingdom BNB Dividends:</Text>
            <Text>3%</Text>
          </Flex>
          <Flex justifyContent="space-between">
          ...
          <Flex justifyContent="space-between">
            <Text>NBIT Burn Rate:</Text>
            <Text>100% of Fees Buyback and Burn NBIT</Text>
          </Flex>
          <Flex justifyContent="space-between">
