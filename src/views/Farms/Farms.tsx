...
const Farms: React.FC<FarmsProps> = ({ tokenMode, kingdomMode }) => {
  ...
  let heading = TranslateString(320, 'Stake LP tokens to earn NBIT')
  const subHeading = TranslateString(10000, 'Deposit Fee will be used to buyback NBIT.')
  // let extra = null
  ...
  if (tokenMode) {
    ...
    heading = TranslateString(10002, 'Stake tokens to earn NBIT')
  }
  ...
  return (
    <>
      ...
      <Page>
        ...
        {renderContent()}
        <div ref={loadMoreRef} />
        <Image src="/images/cub/" alt="illustration" width={1352} height={587} responsive />
      </Page>
    </>
  )
}
